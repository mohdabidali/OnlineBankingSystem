       ...
       <div class="heading">
        Login in     
         ...
         <input type="password"class="form-control input-lg " name="password"  placeholder="Password" required>
               ...
               <div class="form-group field">
           <input type="submit" class="field "value="submit" style="  background-color:  #032965;border-radius: 15px 15px 15px 15px;
        border: 1px solid   #032965;line-height:35px;" name="submit"> </div>
           </form>
        </div>
    </div>
    </body>
